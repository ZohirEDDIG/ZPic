...
const Footer = () => {
    ...
    return (
        <footer className='bg-white dark:bg-dark-two -mx-4 mt-6 -mb-4'>

            <div className='p-4 flex flex-col gap-y-4'>

                <div className='flex flex-wrap justify-between items-center gap-x-20 gap-y-6'>

                    <p className='text-dark-three text-xs font-bold'>{t('copyright')}</p>
                    
                    <div className='flex gap-x-3'>
                    
                        <a href='/' className='text-dark-three cursor-pointer select-none transition-colors duration-300 ease-in-out hover:text-[#e60023]'><Pinterest /></a>

                        <a href='/' className='text-dark-three cursor-pointer select-none transition-colors duration-300 ease-in-out hover:text-[#106aff]'><Twitter /></a>

                        <a href='/' className='text-dark-three cursor-pointer select-none transition-colors duration-300 ease-in-out hover:text-[#249ef0]'><Facebook /></a>
